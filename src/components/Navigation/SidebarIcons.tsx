...
export const UpgradeToProIcon: React.FC = () => (
...
export const DocumentationIcon: React.FC = () => (
  <svg className="w-6 h-6 text-gray-500 flex-shrink-0 group-hover:text-gray-900 transition duration-75" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
    <path d="M7 3a1 1 0 00-1 1v12a1 1 0 102 0V4a1 1 0 00-1-1zM10.293 9.293a1 1 0 001.414 1.414l3-3a1 1 0 000-1.414l-3-3a1 1 0 10-1.414 1.414L11.586 9H4a1 1 0 100 2h7.586l-1.293 1.293z"></path>
  </svg>
);
