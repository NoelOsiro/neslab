                  ...
                  <div className="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8  2xl:col-span-2">
                     <div className="flex items-center justify-between mb-4">
                        <div className="flex-shrink-0">
                           <span className="text-2xl sm:text-3xl leading-none font-bold text-gray-900">Operator Pane</span>
                           <h3 className="text-base font-normal text-gray-500">Select the product</h3>
                        </div>
                     </div>
